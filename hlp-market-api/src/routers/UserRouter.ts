...
userRouter.get('/api/users/:id', authMiddleware, checkUserPermission(), (req, res) => userController.findById(req, res)); // findById can be accessed by self or admin
userRouter.put('/api/users/:id', authMiddleware, checkUserPermission(), (req, res) => userController.update(req, res));
userRouter.put('/api/users/:id/password', authMiddleware, checkUserPermission(), (req, res) => userController.updatePassword(req, res));
